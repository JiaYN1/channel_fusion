...
hrms_data_path = '../output/oriQB/channel/'
# hrms_data_path = '/media/hdr/Elements SE/demos/Pan-sharpening/pannet/pannet-results/test-samples-v1/testGF2'
# hrms_data_path = '/media/hdr/Elements SE/demos/Pan-sharpening/GPPNN/output/test_fused'
# real_data_path = '../output/real/real_spectral_dense'
pan_data_path = ''
# hrms_out_path = '/media/hdr/Elements SE/demos/Pan-sharpening/output/GF2/pannet'
hrms_out_path = '/media/hdr/Elements SE/demos/Pan-sharpening/output/oriQB/channel/'

real_out_path = '/media/hdr/Elements SE/demos/Pan-sharpening/output/HFPS/GF2real'
...
def tif_png(rasterfile):
    ...
    if bands == 4:
        ...
        B1 = imgto8bit(B)
        IR1 = imgto8bit(IR)
        # img_out = cv2.merge([R1, G1, B1, IR1])
...
def main():
    ...
    if not os.path.exists(real_out_path):
        os.makedirs(real_out_path)
