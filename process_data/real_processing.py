...
if __name__ == "__main__":
    ...
    outDir = '%s/Dataset/%s/full-resolution/' % (dataDir, satellite)
    ...
    for i in range(13, 15):
        newMul_o = outDir + str(i) + '_mul_o.tif'
        # newMul_o_u = outDir + str(i) + '_mul_o_u.tif'

        newPan_o = outDir + str(i) + '_pan_o.tif'
        # newPan_o_d = outDir + str(i) + '_pan_o_d.tif'
        ...
        imgMul_o = cv2.resize(rawMul, (w, h))
        imgPan_o = cv2.resize(rawPan, (w * 4, h * 4))
        ...
        # print('mul_o:', imgMul_o.shape, ' pan_o:', imgPan_o.shape)
        print('mul_o:', imgMul_o.shape,
              ' pan_o:', imgPan_o.shape, )
        print('done %d' % i)
